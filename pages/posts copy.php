<?php
    ...
    $stmt = $db->query("SELECT posts.*, users.username FROM posts JOIN users ON posts.user_id = users.id ORDER BY posts.id DESC LIMIT 5");
                    ...
                    <div class="dropdown">
                        ...
                        <form id="sortForm" method="POST">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item w-100" href="#" type="submit" name="submit" name="latest">Latest</a></li>
                                <li><a class="dropdown-item w-100" href="#" type="submit" name="submit" name="oldest">Oldest</a></li>
                                <li><a class="dropdown-item w-100" href="#" type="submit" name="submit" name="title">Title (a-z)</a></li>
                                <li><a class="dropdown-item w-100" href="#" type="submit" name="submit" name="last_updated">last updated</a></li>
                            </ul>
                        </form>
                    </div>
                </div>
